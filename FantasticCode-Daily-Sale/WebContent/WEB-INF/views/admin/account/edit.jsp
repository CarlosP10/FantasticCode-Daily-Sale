		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div
					...
					<div class="form-group">
						<label for="inputMunicipality">Dirección</label> <input
							type="text" class="form-control" id="inputAddress"
							name="uaddress" aria-describedby="addressHelp"
							value="${account.user.uaddress}" readonly> <small
							id="addressHelp" class="form-text text-muted"> Direccion
							de la persona.</small>
					</div>
				...
				<div class="form-group">
					<label for="inputState">Estado del usuario</label> <input
						type="text" class="form-control" id="inputState name="
						activestate" aria-describedby="activestateHelp"
						value="${account.activestate}"> <small
						id="activestateHelp" class="form-text text-muted">Estado
						activo o inactivo</small>
				</div>

				<div class="form-group">
					<label for="inputOnline">Online</label> <input type="text"
						class="form-control" id="inputOnline" name="onlinestatus"
						aria-describedby="OnlineHelp" value="${account.onlinestatus}"
						readonly> <small id="OnlineHelp"
						class="form-text text-muted"> Estado Online.</small>
				</div>

				<div class="form-group">
					<label for="inputComentario">Comentario</label> <input type="text"
						class="form-control" id="inputComentario" name="comment"
						aria-describedby="commentHelp" value="${account.comment}" readonly>
					<small id="commentHelp" class="form-text text-muted">Comentario
						en caso de ser desactivado.</small>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="inputRole">Rol</label> <input type="text"
						...
						aria-describedby="roleHelp" value="${account.role.idrole}"
