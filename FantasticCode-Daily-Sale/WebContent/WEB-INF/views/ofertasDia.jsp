...
<body>
	<form action="${pageContext.request.contextPath}/ofertasDia" method ="post">
		...
		<div class="contenedor-anuncios">
			<div class="anuncio">
				...
				<div class="contenido-anuncio">
					...
					<a href="${pageContext.request.contextPath}/login" class="boton boton-amarillo d-block">Ver Información</a>
				</div>
			</div>
			<div class="anuncio">
				<img alt="Anuncio 1" src="./resources/img/anuncio1.jpg">
