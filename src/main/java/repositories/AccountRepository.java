...
public interface AccountRepository extends JpaRepository<Account, Integer> {
	...
	public int findOneUserInt(@Param("username") String username, @Param("password") String password)
			throws DataAccessException;

	@Query(nativeQuery = true, value = "select * from public.table_account where username= :username and password= :password")
	public Account findOneUser(@Param("username") String username, @Param("password") String password)
			throws DataAccessException;
	...
	public int findOneUserActive(@Param("username") String username, @Param("password") String password)
			throws DataAccessException;
